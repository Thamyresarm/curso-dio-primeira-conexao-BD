...
public class AplicacaoEntityManager {
    public static void main(String[] args) {
        ...
        EntityManagerFactory entityManagerFactory = Persistence.createEntityManagerFactory("jpaimplements"); // nome da persistence definido no xml
